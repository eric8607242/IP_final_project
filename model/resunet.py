...
class ResNetUNet(nn.Module):
    def __init__(self, n_class=1):
        ...
        self.conv_original_size = conv_relu(1, 3, 3, (9, 7))
    ...
    def forward(self, x):
        x_channel = self.conv_original_size(x)
        x_orginal = self.conv_original_size0(x_channel)
        x_orginal = self.conv_original_size1(x_orginal)

        layer0 = self.layer0(x_channel)
